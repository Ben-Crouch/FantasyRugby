...
class Command(BaseCommand):
    help = 'Set up Databricks tables for user-created leagues'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Creating Databricks tables...")
        
        if client.create_user_league_tables():
        ...
        self.stdout.write("Databricks setup completed!")
